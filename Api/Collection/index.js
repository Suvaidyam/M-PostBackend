...
router.put('/softDelete/:workspaceData/:collectionData/:_id', crud.softDeleteCollection);
router.put('/restore/:_id', crud.restore);
router.get('/getById/:_id', crud.getCollectionById);
// router.get('/', crud.getCollection);
router.post('/:workspaceData/:collectionData', upload.single('img'), crud.postCollection);
router.put('/:workspaceData/:collectionData/:_id', crud.putCollection);
